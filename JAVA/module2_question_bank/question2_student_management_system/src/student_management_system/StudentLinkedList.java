...
public class StudentLinkedList {
	...
	public static void addStudent(LinkedList<Student> al) {
	...
	public static void printDetails(LinkedList<Student> al) {
	...
	public static void removeDetails(LinkedList<Student> al,int id) {
		int d=searchDetails(al,id);
		if(d!=0) {
		al.remove(d-1);
		}
	}
	public static int searchDetails(LinkedList<Student> al,int id) {
		for(int i=0;i<al.size();i++) {
			if(al.get(i).id==id) {
